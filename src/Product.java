...
public class Product extends MenuPanel {
    ...
    Product(int productId, String productGroup, int unitPrice, int disocuntRate, int stockAmount, String nameOfProduct, String brandInfo) {
        super();
...
*/
  /*  public void ProductDAO() {
        Product product1 = new Product("Notebook", 1, 7_000, 5, 5, " Matebook 14", "HUAWEI");
        Product product2 = new Product("Notebook", 2, 3_699, 10, 5, " V14 IGL", "LENOVO");
        Product product3 = new Product("Notebook", 3, 8_199, 15, 5, " Tuf Gaming", "ASUS");

        Product product4 = new Product("Mobile Phone", 4, 3_199, 10, 5, "GALAXY A51", "SAMSUNG");
        Product product5 = new Product("Mobile Phone", 5, 7379, 5, 5, "11 64 GB", "IPhone");
        Product product6 = new Product("Mobile Phone", 6, 4012, 15, 5, " Redmi Note 10 Pro 8 GB", "Xiaomi");
